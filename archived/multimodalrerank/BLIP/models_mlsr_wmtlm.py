...
class BlipForQuestionAnswering(BlipForQuestionAnswering_hf):
    ...
    def forward(
        ...
        product_result_0_kd = self.splade_max(product_logits_0_kd, decoder_attention_mask) ##(bsz, Vocab)
        product_result_1_kd = self.splade_max(product_logits_1_kd, decoder_attention_mask) ##(bsz, Vocab)
