...
python3 multimodal2text/BLIP/pretrain_mlsr.py \
    ...
    --max_src_length 128 \
    --max_tgt_length 16 \
    --output_dir models/blip-base-prt-mlsr-max/ \
    ...
    --template_tgt "{0}" \
    --pooling max \
    --run_name blip-base-prt-mlsr-max-spladedistill
...
#     --max_src_length 128 \
#     --max_tgt_length 16 \
#     --output_dir models/blip-base-prt-mlsr-max-wgen/ \
#     --overwrite_output_dir true \
#     --do_train \
#     --save_strategy steps \
#     --max_steps 50000 \
...
#     --pooling max \
#     --run_name blip-base-prt-mlsr-max-wgen-spladedistill
