...
class BlipForQuestionAnswering(BlipForQuestionAnswering_hf):
    ...
    def forward(
        ...
        # image-text representation: [ENC] text+image
        ...
        # text representation (query): [ENC] text
        ...
        # decoding from text-iamge representation: [DEC] text
