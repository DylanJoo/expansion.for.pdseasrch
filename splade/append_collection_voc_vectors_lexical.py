...
def generate_vocab_vector(docs, model, minimum=0, device='cpu', max_length=256, quantization_factor=1000):
    ...
    # list of tokens
    tokenlist = a.input_ids.tolist()
    # list of token-to-word idx
    token2word = [inputs.word_ids(i) for i in range(inputs.input_ids.size(0))]
